...
export class PersistenceManager {
    ...
    static async saveVariables(provider: LiveWatchProvider, context: vscode.ExtensionContext) {
        try {
            ...
            const rootElements = (provider as any).rootElements as (LiveWatchVariable | VariableGroup)[];
    ...
    static async loadVariables(provider: LiveWatchProvider, context: vscode.ExtensionContext) {
        try {
            const savedVars: SavedVariable[] | undefined = context.globalState.get(this.globalStateKey);
